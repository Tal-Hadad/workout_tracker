...
import StartWorkoutButton from "./components/workout/StartWorkoutButton/StartWorkoutButton";
...
export default function Home() {
  const { history, loading, saveWorkout, updateWorkout, deleteWorkout } =
    useWorkoutHistory();
  ...
  return (
    <>
      <main className={styles.page}>
        <h1>Workout</h1>
        <StartWorkoutButton onSave={saveWorkout} />
      </main>
